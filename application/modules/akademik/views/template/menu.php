        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbar-main">
                <ul class="nav navbar-nav">	
                    <li><a href="<?php echo base_url(); ?>dashboard"><i class="icon-home icon-white"> </i> Beranda</a></li>
                    <li class="dropdown">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="themes">
                            ...
                            <li><a tabindex="-1" href="<?php echo base_url(); ?>akademik/login/logout">Logout</a></li>
                        </ul>
                    </li>
                </ul>
